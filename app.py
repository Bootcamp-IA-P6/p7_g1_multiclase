...
#     with chat_container:
#         # Mostrar solo los últimos mensajes (ej: 4)
#         max_messages = 3
...
#         # PASO 4: Mostrar botón para abrir modal
#         elif st.session_state.step == 4:
#              st.markdown("## 🎯 Resultados")

#             # Aquí va el resultado
#              st.success("Aquí aparecerán tus resultados 👇")
...
# #     # Ocultar las 3 columnas y mostrar resultados a pantalla completa
# #     st.markdown("---")
...
# #         if not any('He completado el análisis' in msg.get('content', '') for msg in st.session_state.chat_history):
# #             st.session_state.chat_history.append({
# #                 'role': 'assistant',
# #                 'content': f'📊 He completado el análisis. Tu categoría es: **{info_categoria["nombre"]}** con un {confianza:.1f}% de confianza. Nivel de riesgo: **{info_categoria["riesgo"]}**.'
# #             })
...
# #         # Botón cerrar arriba
# #         col_space, col_close = st.columns([6, 1])
# #         with col_close:
# #             if st.button("⬅️ Volver", key="close_top"):
# #                 st.session_state.step = 3  # Volver al paso anterior
# #                 if hasattr(st, 'rerun'):
# #                     st.rerun()
# #                 else:
# #                     st.experimental_rerun()
...
# #         with col1:
# #             st.markdown(f"""
# #                 <div style='background-color: {info_categoria["color"]}22; padding: 25px; border-radius: 10px; text-align: center;'>
# #                     <p style='margin: 0; font-size: 16px; color: #666;'>Categoría</p>
# #                     <p style='margin: 10px 0 0 0; font-size: 26px; font-weight: bold; color: {info_categoria["color"]};'>
...
# #         with col2:
# #             st.markdown(f"""
# #                 <div style='background-color: #E6F1FB; padding: 25px; border-radius: 10px; text-align: center;'>
# #                     <p style='margin: 0; font-size: 16px; color: #666;'>Confianza</p>
# #                     <p style='margin: 10px 0 0 0; font-size: 26px; font-weight: bold; color: #185FA5;'>
# #                         {confianza:.1f}%
# #                     </p>
# #                 </div>
# #             """, unsafe_allow_html=True)
...
# #             }
# #             st.markdown(f"""
# #                 <div style='background-color: {color_riesgo[info_categoria["riesgo"]]}22; padding: 25px; border-radius: 10px; text-align: center;'>
# #                     <p style='margin: 0; font-size: 16px; color: #666;'>Nivel de Riesgo</p>
# #                     <p style='margin: 10px 0 0 0; font-size: 26px; font-weight: bold; color: {color_riesgo[info_categoria["riesgo"]]};'>
...
# #         # Gráfico y recomendaciones lado a lado
# #         col_grafico, col_recom = st.columns([1.5, 1])
...
# #                 xaxis=dict(title="Probabilidad (%)", range=[0, 100], gridcolor='#E0E0E0'),
...
# #         with col_btn1:
# #             if st.button("📥 Guardar Resultado", use_container_width=True, key="save_result"):
...
# #                 st.success("✅ Guardado exitosamente en data/historico.csv")
...
# #         with col_btn3:
# #             if st.button("⬅️ Volver", use_container_width=True, key="close_bottom"):
# #                 st.session_state.step = 3  # Volver al paso anterior
# #                 if hasattr(st, 'rerun'):
# #                     st.rerun()
# #                 else:
...
# #                 <strong>⚕️ Importante:</strong> Este diagnóstico es orientativo y debe ser interpretado 
# #                 por un profesional de la salud. No sustituye una consulta médica ni nutricional personalizada.
# #             </div>
# #         """, unsafe_allow_html=True)
...
# #         st.session_state.chat_history.append({
# #             'role': 'assistant',
# #             'content': f'Lo siento, hubo un error técnico al procesar tu información: {e}'
# #         })
        ...
        try:
            ...
            fig.update_layout(
                ...
                yaxis=dict(
                    title="", 
                    autorange="reversed",
                    tickfont=dict(size=15, color='#333', family='Arial')
                ),
                plot_bgcolor='white',
                paper_bgcolor='white',
            ...
            for i, rec in enumerate(info_categoria['recomendaciones'], 1):
                st.markdown(f"""
                    <div style='
                        background: linear-gradient(135deg, #EAF3DE 0%, #D5E8C3 100%);
                        padding: 16px;
                        border-radius: 10px;
                        margin: 12px 0;
                        ...
                        font-weight: 500;
                    '>
                        <strong style="font-size: 16px; color: #27500A;">🔹 {i}.</strong> {rec}
                    </div>
                """, unsafe_allow_html=True)
