...
#             with col_btn2:
#                 if st.button(" Modificar", use_container_width=True, key="back_step"):
...
#             st.markdown("""
#                 <div class='warning-box' style='font-size: 15px; padding: 12px;'>
...
# # CSS personalizado - Ocean Blue Professional Design
# st.markdown("""
#     <style>
...
#             with col1:
#                 st.markdown(f"""
#                     <div style='background: linear-gradient(135deg, {info_categoria["color"]}22 0%, {info_categoria["color"]}11 100%); padding: 22px; border-radius: 16px; text-align: center; border: 2px solid {info_categoria["color"]}44;'>
#                         <p style='margin: 0; font-size: 15px; color: #0c4a6e; font-weight: 600;'>Categoría</p>
#                         <p style='margin: 10px 0 0 0; font-size: 24px; font-weight: 800; color: {info_categoria["color"]};'>
#                             {info_categoria['icono']} {info_categoria['nombre']}
#                         </p>
#                     </div>
#                 """, unsafe_allow_html=True)
...
#             with col2:
#                 st.markdown(f"""
#                     <div style='background: linear-gradient(135deg, #cffafe 0%, #e0f2fe 100%); padding: 22px; border-radius: 16px; text-align: center; border: 2px solid #06b6d444;'>
#                         <p style='margin: 0; font-size: 15px; color: #0c4a6e; font-weight: 600;'>Confianza</p>
#                         <p style='margin: 10px 0 0 0; font-size: 24px; font-weight: 800; color: #0891b2;'>
#                             {confianza:.1f}%
#                         </p>
#                     </div>
#                 """, unsafe_allow_html=True)
...
#                 }
#                 st.markdown(f"""
#                     <div style='background: linear-gradient(135deg, {color_riesgo[info_categoria["riesgo"]]}22 0%, {color_riesgo[info_categoria["riesgo"]]}11 100%); padding: 22px; border-radius: 16px; text-align: center; border: 2px solid {color_riesgo[info_categoria["riesgo"]]}44;'>
#                         <p style='margin: 0; font-size: 15px; color: #0c4a6e; font-weight: 600;'>Riesgo</p>
#                         <p style='margin: 10px 0 0 0; font-size: 24px; font-weight: 800; color: {color_riesgo[info_categoria["riesgo"]]};'>
#                             {info_categoria['riesgo']}
#                         </p>
#                     </div>
#                 """, unsafe_allow_html=True)
...
#             with col_btn2:
#                 if st.button("⬅️ Modificar Datos", use_container_width=True, key="back_step"):
#                     st.session_state.step = 3
#                     if hasattr(st, 'rerun'):
#                         st.rerun()
#                     else:
